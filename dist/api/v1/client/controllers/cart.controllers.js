...
const getCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const cart = yield cart_model_1.default.findOne({ UserId }).populate("myCart.productId", "title price images");
        if (!cart) {
            const newCart = yield cart_model_1.default.create({ UserId, myCart: [] });
            return res
                .status(200)
                .json({ success: true, data: { myCart: newCart.myCart } });
        }
        res
            .status(200)
            .json({
...
const addToCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (productIndex > -1) {
            ...
            cart.myCart[productIndex].totalPrice =
                Number(product.price) * cart.myCart[productIndex].quantity;
        }
        else {
...
const updateCartQuantity = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res
            .status(200)
            .json({ success: true, message: "Product quantity updated", data: cart });
    }
    catch (error) {
        res
            .status(500)
